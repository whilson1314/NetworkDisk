#ifndef SHAREDFILEFEIENDLIST_H
#define SHAREDFILEFEIENDLIST_H
...
class sharedFileFeiendList : public QWidget
{
    Q_OBJECT
public:
    explicit sharedFileFeiendList(QWidget *parent = nullptr);
